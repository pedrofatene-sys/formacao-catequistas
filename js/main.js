...
const channels = [
    { id: '4En-IIYll5g', name: 'Como ler os Evangelhos?' },
    { id: 'CboMzsfXmNo', name: 'Como estudar o Catecismo da Igreja Católica?' },
    { id: 'sjzXzqW3azw', name: 'O católico e as imagens | Elementos essenciais de mariologia' },
    { id: 'M6XhXPg51Kk', name: 'Como falar da fé às novas gerações?' },
    { id: 'ZiebI5S7u7M', name: 'Preparar para a confissão | Entender os pecados capitais' },
    { id: '40TqTlu9PX0', name: 'A catequese e a vida sacramental: fonte, força e alegria da vida cristã' }
];
